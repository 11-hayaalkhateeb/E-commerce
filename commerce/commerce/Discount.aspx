<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Discount.aspx.cs" Inherits="commerce.Discount" %>
...
        </nav>
    ...
    <div class="container">
         <div class="cards">
            <div class="card-img">
                <img src="img/dis2.jpg" alt="Alternate Text" />
                </div>
                <div class="card-body">
                    <h1>Electronic</h1>
                    <p> kalatd gd dhb dhvvf hsdhd dhdg  </p>
                    <asp:Label ID="Label1" runat="server" Text="Label" style="text-decoration: line-through  "  Font-Bold="True">60jd </asp:Label>
                    <asp:Label ID="Label2" runat="server" Text="Label" Font-Bold="True"><span style="color:red ">42jd</span></asp:Label>
<%--                   <h3 style="text-decoration: line-through"> 60jd  <span>42jd</span> </h3>   --%>
                    </div>
                    <div class="rating">
    ...
    <div class="ss">
        <div class="part-two">
            <div class="cards">
            <div class="card-img">
                <img src="img/dis3.jpg" alt="Alternate Text" />
                </div>
                <div class="card-body">
                    <h1>Electronic</h1>
                    <p> kalatd gd dhb dhvvf hsdhd dhdg  </p>
            ...
            <div class="cards">
            <div class="card-img">
                <img src="img/dis4.jpg" alt="Alternate Text" />
                </div>
                <div class="card-body">
                    <h1>Electronic</h1>
                    <p> kalatd gd dhb dhvvf hsdhd dhdg  </p>
